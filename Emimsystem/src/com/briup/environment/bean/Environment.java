...
public class Environment implements Serializable {
	...
	public Environment(String name, String srcId, String dstId, String a2, String sersorAddress, int arr,
			String cmd, int status, float data, Timestamp arr2) {
		super();
		this.name = name;
		this.srcId = srcId;
		this.dstId = dstId;
